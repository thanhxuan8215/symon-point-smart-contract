...
convertToPubKeyHash :: Address.Address -> PubKeyHash
convertToPubKeyHash addr = do
    let mPkh = Address.toPubKeyHash addr
    case mPkh of
        Just pkh -> pkh
        Nothing -> error $ "can't parse to pkh"
